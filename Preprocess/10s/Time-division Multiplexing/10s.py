...
def main():
    ...
    input_dirs = os.path.join(project_root, 'Datasets', 'Original', '10s', '20_per_1_time', '10s')
    output_file = os.path.join(project_root, 'Datasets', 'Processed', '10s', '20_per_1_time', '10s.csv')
