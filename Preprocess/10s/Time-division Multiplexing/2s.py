...
def main():
    ...
    input_dirs = [os.path.join(project_root, 'Datasets', 'Original', '10s', '20_per_1_time', '2s', f'2s_{i}') for i in range(1, 6)]
    output_file = os.path.join(project_root, 'Datasets', 'Processed', '10s', '20_per_1_time', '2s.csv')
