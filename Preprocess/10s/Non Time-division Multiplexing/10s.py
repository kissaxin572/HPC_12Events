...
def main():
    ...
    input_dirs = os.path.join(project_root, 'Datasets', 'Original', '10s', '4_per_5_times', '10s')
    output_file = os.path.join(project_root, 'Datasets', 'Processed', '10s', '4_per_5_times', '10s.csv')
