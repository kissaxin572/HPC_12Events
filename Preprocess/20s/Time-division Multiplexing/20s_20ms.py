...
def main():
    ...
    input_dirs = os.path.join(project_root, 'Datasets', 'Original', '20s', '20_per_1_time', '20s_20ms')
    output_file = os.path.join(project_root, 'Datasets', 'Processed', '20s', '20_per_1_time', '20s_20ms.csv')
