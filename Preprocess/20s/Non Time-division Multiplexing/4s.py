...
def main():
    ...
    input_dirs = [os.path.join(project_root, 'Datasets', 'Original', '20s', '4_per_5_times', '4s', f'4s_{i}') for i in range(1, 6)]
    output_file = os.path.join(project_root, 'Datasets', 'Processed', '20s', '4_per_5_times', '4s.csv')
