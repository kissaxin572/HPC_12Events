...
def main():
    ...
    input_dirs = os.path.join(project_root, 'Datasets', 'Original', '20s', '4_per_5_times', '20s_200ms')
    output_file = os.path.join(project_root, 'Datasets', 'Processed', '20s', '4_per_5_times', '20s_200ms.csv')
