...
def main():
    ...
    input_dirs = os.path.join(project_root, 'Datasets', 'Original', '30s', '20_per_1_time', '30s')
    output_file = os.path.join(project_root, 'Datasets', 'Processed', '30s', '20_per_1_time', '30s.csv')
