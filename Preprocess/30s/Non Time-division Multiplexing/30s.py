...
def main():
    ...
    input_dirs = os.path.join(project_root, 'Datasets', 'Original', '30s', '4_per_5_times', '30s')
    output_file = os.path.join(project_root, 'Datasets', 'Processed', '30s', '4_per_5_times', '30s.csv')
