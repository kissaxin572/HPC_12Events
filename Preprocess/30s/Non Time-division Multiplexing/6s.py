...
def main():
    ...
    input_dirs = [os.path.join(project_root, 'Datasets', 'Original', '30s', '4_per_5_times', '6s', f'6s_{i}') for i in range(1, 6)]
    output_file = os.path.join(project_root, 'Datasets', 'Processed', '30s', '4_per_5_times', '6s.csv')
